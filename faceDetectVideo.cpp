...
int main() {
	std::string facial_model_file = "/home/ronnieji/lib/webcam/haarcascade_frontalface_default.xml";
	std::string faces_img_storage_folder_path = "/home/ronnieji/lib/webcam/capture";
