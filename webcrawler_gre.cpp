/*
    ...
    Compile:
    g++ /Volumes/WorkDisk/MacBk/pytest/NLP_test/src/webcrawler_gre.cpp -o /Volumes/WorkDisk/MacBk/pytest/NLP_test/src/webcrawler_gre -I/usr/local/include/eigen3/ -I/usr/local/boost/include/ -I/opt/homebrew/Cellar/icu4c/73.2/include/ -L/opt/homebrew/Cellar/icu4c/73.2/lib -licuuc -licudata /usr/local/boost/lib/libboost_system.a /usr/local/boost/lib/libboost_filesystem.a /Volumes/WorkDisk/MacBk/pytest/NLP_test/src/lib/nemslib.a -I/Users/dengfengji/miniconda3/pkgs/sqlite-3.41.2-h80987f9_0 -lsqlite3 -std=c++20
*/
#include <iostream>
#include <string>
#include <curl/curl.h>
...
void expend_english_voc(){
	...
	*/
	std::string folderPath = "/Volumes/WorkDisk/MacBk/pytest/NLP_test/corpus/raw_data/vocabulary/web"; // Open the english book folder path
...
int main() {
	...
	expend_english_voc();
	std::cout << "Successfully get the word list in the db!" << std::endl;
    return 0;
}